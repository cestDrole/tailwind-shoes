  ...
  return (
    ...
    >
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 z-10'>
        ...
        <h1 className='sm:mt-10 font-palanquin text-4xl md:text-8xl max-sm:text-[72px] relative font-bold'>
          <span className='xl:bg-white xl:whitespace-nowrap z-10 sm:pr-10 text-[40px] md:text-8xl'>
            The New Arrival
          </span>
          <br />
          <span className='text-coral-red inline-block sm:mt-3 text-[40px] md:text-8xl'>
            Nike
          </span>{" "}
          <span className='sm:mt-3 text-[40px] md:text-8xl'>Shoes</span>
        </h1>
        ...
        />
        <div className='flex justify-start items-start flex-wrap w-full mt-10 gap-8 sm:gap-16'>
          {statistics.map((stat) => (
            <div key={stat.label}>
